...
plot_holdout_avg <- function(data, title) {
  ggplot(data) +
    ...
    labs(x = "Bidding Cycles Occured", y = "Holdout Ratio",
         title = paste(title, "Holdout Ratio"), 
         subtitle = "Average Holdout Ratio for Each Bidding Cycle")
}

plot_holdout_avg(base_analysis, "Area")
plot_holdout_avg(aff_analysis, "Affluent Area")
plot_holdout_avg(asym_analysis, "Asymmetric Market")
...
plot_buyout_avg <- function(data, title){
  ggplot(data) +
    ...
    labs(x = "Bidding Cycles Occured", y = "Mortgage Buyout Ratio",
         title = paste(title, "Mortgage Buyout Ratio"), 
         subtitle = "Average Mortgage Buyout Ratio for Each Bidding Cycle")    
}

plot_buyout_avg(base_analysis, "Area")
plot_buyout_avg(aff_analysis, "Affluent Area")
plot_buyout_avg(asym_analysis, "Asymmetric Market")
...
plot_network_avg <- function(data, title) {
  ggplot(data) +
    ...
    labs(x = "Bidding Cycles Occured", y = "Social Network Links",
         title = paste(title, "Social Network Change"), 
         subtitle = "Average Number of Network Links for Each Bidding Cycle")      
}

plot_network_avg(base_analysis, "Area")
plot_network_avg(aff_analysis, "Affluent Area")
plot_network_avg(asym_analysis, "Asymmetric Market")

plot_buyout_roc <- function(data, title) {
    ggplot(data) +
    geom_line(aes(x = Ticks, y = buyout_roc)) +
    labs(x = "Bidding Cycles Occured", y = "Mortgage Buyout Percent Change",
         title = paste(title, "Buyout Percent Change"), 
         subtitle = "Percent Change in Mortgage Buyout Ratio for Each Bidding Cycle")  
}

plot_buyout_roc(base_analysis, "Area")
plot_buyout_roc(aff_analysis, "Affluent Area")
plot_buyout_roc(asym_analysis, "Asymmetric Market")
```