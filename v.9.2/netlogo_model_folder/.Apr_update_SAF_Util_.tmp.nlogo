...
globals[ ;
 ...
 interest_rate ; could represent  change in  percpetion of area due to development. The value coudl be postive or negative. For this model it is assumed equity is not being built in
